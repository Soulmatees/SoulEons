...
public class BiomeSourceMixin implements BiomeSourceAccessor {
    ...
    public void setResourceKeyMap(Map<ResourceKey<Biome>, Holder<Biome>> map) { this.map = map; }
    public Map<ResourceKey<Biome>, Holder<Biome>> getResourceKeyMap() { return map; }
